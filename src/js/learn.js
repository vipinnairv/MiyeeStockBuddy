...
const LEARN_BLOCKS = [
  {"k":"box","kind":"note","label":"Read this first","lines":[[{"t":"This guide assumes you know nothing about markets. Every technical term is explained the moment it appears, with an everyday comparison to make it stick."}],[{"t":"Nothing here is investment advice. It is education. No indicator, pattern or ratio in this guide predicts the future. They describe what has already happened, and they help you ask better questions before you risk your own money."}]]},
  {"k":"h1","t":"Contents"},
  {"k":"p","r":[{"t":"Five parts, in the order a beginner should read them. Part 1 explains why prices move at all. Part 2 is about the business behind the share. Part 3 and Part 4 are about reading the chart. Part 5 covers everything beyond ordinary shares."}]},
  ...
  {"k":"p","r":[{"t":"This is worth repeating because beginners often assume a falling price means the company is in trouble. Sometimes it does. Often it just means a large holder needed cash that week, and there were not enough buyers that day to absorb the shares."}]},
  ...
  {"k":"h3","t":"ROE and ROCE: the difference that catches beginners out"},
  ...
  {"k":"p","r":[{"t":"This is the ratio most beginners have never heard of, and it is the one that exposes the most trouble."}]},
  ...
  {"k":"p","r":[{"t":"Each candle summarises one time period, usually one day on the charts a beginner should start with. It packs four numbers into one shape."}]},
  ...
  {"k":"p","r":[{"t":"A pattern is only a shape until price confirms it. The single most common beginner mistake is acting on a shape before it completes. Every rule below waits for a closing price, not an intraday poke."}]},
  ...
  {"k":"table","head":[[{"t":"Reading","b":1}],[{"t":"Name","b":1}],[{"t":"What a beginner should take from it","b":1}]],"rows":[[[{"t":"Above 70"}],[{"t":"Overbought"}],[{"t":"Buyers have pushed hard. Rallies often pause or pull back from here. It is NOT an automatic sell signal."}]],[[{"t":"Below 30"}],[{"t":"Oversold"}],[{"t":"Sellers have pushed hard. Falls often stall and bounce from here. It is NOT an automatic buy signal."}]],[[{"t":"45 to 55"}],[{"t":"Neutral"}],[{"t":"Nobody is in control. The reading carries little information."}]]]},
  {"k":"box","kind":"caution","label":"Careful here","lines":[[{"t":"The classic beginner trap: in a genuinely strong trend, RSI can sit above 70 for weeks while the price keeps climbing. Selling simply because RSI crossed 70 is one of the most reliable ways to exit a good position far too early. Overbought means \"stretched\", not \"finished\"."}]]},
  ...
  {"k":"p","r":[{"t":"ADX measures how strong a trend is. It deliberately does not tell you which direction. This sounds useless and is in fact the most valuable filter a beginner can have."}]},
  {"k":"box","kind":"analogy","label":"Think of it like this","lines":[[{"t":"ADX is not the compass, it is the answer to \"is there a road here at all?\""}],[{"t":"A compass is invaluable on a road. In the middle of a featureless field, the compass still points north confidently while getting you nowhere. Most beginner losses come from following a confident compass across a field."}]]},
  ...
  {"k":"box","kind":"rule","label":"The rule to remember","lines":[[{"t":"Below 1 to 1.5 is usually not worth taking. At 1 to 3, you can be right less than half the time and still make money over many trades. Most beginners chase a high strike rate. Professionals chase a favourable ratio, and accept being wrong often."}]]},
